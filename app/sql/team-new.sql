...
CREATE TABLE member (
  ...
  mpwd    VARCHAR(100) NOT NULL, -- 암호
  memail  VARCHAR(40)  NOT NULL, -- 이메일
  mbirth  DATE         NOT NULL, -- 생년월일
  mtel    INTEGER      NOT NULL, -- 전화번호
  mgender INTEGER      NOT NULL, -- 성별
  mphoto  VARCHAR(255) NULL,     -- 사진
  mstatus INTEGER      NOT NULL, -- 탈퇴여부
  mpow    INTEGER      NOT NULL, -- 관리자권한
  mcnt    INTEGER      NULL      -- 제제횟수
);
...
CREATE TABLE hotplace (
  hno      INTEGER      NOT NULL, -- 게시판 번호
  htitle   VARCHAR(255) NOT NULL, -- 게시판 제목
  hcontent LONGTEXT     NOT NULL, -- 게시판 내용
  hdate    DATE         NOT NULL, -- 등록 날짜
  hcount   INTEGER      NOT NULL, -- 조회수
  haddr    VARCHAR(255) NOT NULL, -- 주소
  hphoto   VARCHAR(255) NULL      -- 사진
);
...
CREATE TABLE b_report (
  b_nno     INTEGER  NOT NULL, -- 신고게시판번호
  bno       INTEGER  NOT NULL, -- 게시판id
  mno       INTEGER  NOT NULL, -- 회원번호
  b_rreason LONGTEXT NOT NULL, -- 신고 사유
  b_rresult INTEGER  NULL      -- 처리결과
);
...
ALTER TABLE b_report
  MODIFY COLUMN b_nno INTEGER NOT NULL AUTO_INCREMENT;

-- 할인정보
CREATE TABLE discount (
  dno      INTEGER      NOT NULL, -- 게시판 번호
  dtitle   VARCHAR(255) NOT NULL, -- 게시판 제목
  dcontent LONGTEXT     NOT NULL, -- 게시판 내용
  ddate    DATETIME     NOT NULL DEFAULT now(), -- 등록 날짜
  dcount   INTEGER      NOT NULL, -- 조회수
  dphoto   VARCHAR(255) NULL      -- 사진
);
...
-- 여행클럽
CREATE TABLE club (
  cno      INTEGER      NOT NULL, -- 클럽게시판번호
  mno      INTEGER      NOT NULL, -- 회원번호
  carrive  VARCHAR(10)  NOT NULL, -- 도착지
  ctheme   VARCHAR(10)  NOT NULL, -- 테마
  ctitle   VARCHAR(255) NOT NULL, -- 제목
  ccontent LONGTEXT     NOT NULL, -- 내용
  csdt     DATE         NOT NULL, -- 출발날짜
  cedt     DATE         NOT NULL, -- 도착날짜
  ctotal   INTEGER      NOT NULL  -- 최대인원수
);
...
CREATE TABLE board (
  bno      INTEGER      NOT NULL, -- 게시판id
  b_tno    INTEGER      NOT NULL, -- 게시판분류번호
  mno      INTEGER      NOT NULL, -- 회원번호
  btitle   VARCHAR(255) NOT NULL, -- 게시판 제목
  bcontent LONGTEXT     NOT NULL, -- 게시판내용
  bcount   INTEGER      NOT NULL, -- 조회수
  bdate    DATETIME     NOT NULL DEFAULT now() -- 작성일
);
...
CREATE TABLE b_reply (
  b_rno      INTEGER  NOT NULL, -- 댓글 번호
  mno        INTEGER  NOT NULL, -- 회원번호
  bno        INTEGER  NOT NULL, -- 게시판id
  b_rdate    DATETIME NOT NULL DEFAULT now(), -- 작성일자
  b_rcontent LONGTEXT NOT NULL  -- 댓글 내용
);
...
ALTER TABLE b_reply
  MODIFY COLUMN b_rno INTEGER NOT NULL AUTO_INCREMENT;

-- QnA게시판
CREATE TABLE m_qna (
  m_qno      INTEGER      NOT NULL, -- QnA번호
  mno        INTEGER      NOT NULL, -- 회원번호
  m_qdate    TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP, -- 작성일
  m_qtitle   VARCHAR(255) NOT NULL, -- 제목
  m_qcontent LONGTEXT     NOT NULL, -- 내용
  a_qcontent LONGTEXT     NULL,     -- 답변내용
  a_qdate    TIMESTAMP    NULL     DEFAULT CURRENT_TIMESTAMP -- 답변일
);
...
ALTER TABLE m_qna
  MODIFY COLUMN m_qno INTEGER NOT NULL AUTO_INCREMENT;

-- 탈퇴회원정보
CREATE TABLE m_delete (
  m_dno     INTEGER  NOT NULL, -- 탈퇴번호
  mno       INTEGER  NOT NULL, -- 회원번호
  m_dreason LONGTEXT NOT NULL, -- 탈퇴사유
  m_ddate   DATE     NOT NULL  -- 탈퇴일
);
...
ALTER TABLE m_delete
  MODIFY COLUMN m_dno INTEGER NOT NULL AUTO_INCREMENT;

-- FAQ게시판
CREATE TABLE faq (
  fno      INTEGER      NOT NULL, -- FAQ번호
  ftitle   VARCHAR(255) NOT NULL, -- 제목
  fdate    DATE         NOT NULL, -- 작성일
  fcontent LONGTEXT     NOT NULL  -- 내용
);
...
CREATE TABLE b_type (
  b_tno    INTEGER      NOT NULL, -- 게시판분류번호
  b_ttitle VARCHAR(255) NOT NULL  -- 게시판이름
);
...
CREATE TABLE b_photo (
  b_pno  INTEGER      NOT NULL, -- 게시판사진번호
  bphoto VARCHAR(255) NOT NULL, -- 사진
  bno    INTEGER      NOT NULL  -- 게시판id
);
...
ALTER TABLE b_photo
  MODIFY COLUMN b_pno INTEGER NOT NULL AUTO_INCREMENT;

-- 여행클럽신고
CREATE TABLE c_report (
  mno       INTEGER  NOT NULL, -- 회원번호
  cno       INTEGER  NOT NULL, -- 클럽게시판번호
  c_rreason LONGTEXT NOT NULL, -- 신고사유
  c_rresult INTEGER  NOT NULL, -- 처리결과
  c_rdate   DATE     NOT NULL  -- 신고일자
);
...
CREATE TABLE c_photo (
  c_pno INTEGER      NOT NULL, -- 클럽사진번호
  cno   INTEGER      NOT NULL, -- 클럽게시판번호
  c_pho VARCHAR(255) NULL      -- 사진
);
...
ALTER TABLE c_photo
  MODIFY COLUMN c_pno INTEGER NOT NULL AUTO_INCREMENT;
